...
<head>
	...
	<link href="/gangnam/resources/user/member/css/memberPostComment.css" rel="stylesheet">
					  				...
					  				<c:otherwise> 
										<c:forEach items="${list }" var="list" varStatus="status">	
											<tr>
												...
												<td><%-- ${list.regDatetime} --%><%-- <c:out value="${list.regDatetime }" /> --%><fmt:formatDate value="${list.regDatetime }"/>2022-12-07</td>
